"""The public-facing SensorMetaWorld API."""
...
class MT1(Benchmark):
    """
    The MT1 benchmark.
    A goal-conditioned RL environment for a single SensorMetaWorld task.
    """
...
class ML1(Benchmark):
    """
    The ML1 benchmark.
    A meta-RL environment for a single SensorMetaWorld task.
...
def make_mt_envs(
    ...
    **kwargs,
    ...
    if name in ALL_V3_ENVIRONMENTS.keys():
        ...
        raise ValueError(
            "Invalid MT env name. Must either be a valid SensorMetaWorld task name (e.g. 'reach-v3'), 'MT10' or 'MT50'."
        )
...
def make_ml_envs(
    ...
    **kwargs,
    ...
    if name in ALL_V3_ENVIRONMENTS.keys():
        ...
        raise ValueError(
            "Invalid ML env name. Must either be a valid SensorMetaWorld task name (e.g. 'reach-v3'), 'ML10', 'ML25', or 'ML45'."
        )
